...
Note that this game can go on for at most a 100 steps, and in fact at most 20 when you employ said winning strategy. So one way to go about this is to declare 20 variables to track the 20 numbers said between the players. But a moment's reflection may reveal that you *don't* need to store anything at all. 
